...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.linkedin.com/in/franklin-oduro} & Mobile : \href{tel:+233554587077}\\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Information Technology;  GPA: 3.35}{Sep. 2018 -- Dec. 2021}
    \resumeSubheading
      {Koforidua Technical University}{Koforidua, Ghana}
      {Higher National Diploma In Mechanical Engineering;  GPA: 3.03 {Aug. 2013 -- July. 2016}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Morgan Stanley}{Remote, NewYork Office}
      {Contingent Software Engineer}{Feb 2020 - Present}
      \resumeItemListStart
